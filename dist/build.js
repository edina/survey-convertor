    ...
    _createClass(Convertor, [{
        ...
        value: function getForm(html) {
            ...
            $html.filter(".fieldcontain").each(function () {
                ...
                if (id !== undefined) {
                    var type = id.split("-")[1];
                    this.form[id] = c.fieldToJSON(type, $this);
                }
            });
            return this.form;
        }
         ...
         * @param {String} type the type of the fieldcontain: text, textarea etc
         * @param {Object} the html object of the fieldcontain-general
         * @returns {Object} the json object of html field
         */
    }, {
        key: 'fieldToJSON',
        value: function fieldToJSON(type, html) {
            var field = {};
            var c = this;
            switch (type) {
                case 'text':
        ...
        key: 'JSONtoHTML',
        value: function JSONtoHTML(form) {
            if (form) {
                this.form = form;
            }
            var html = [];
        ...
        key: 'HTMLtoJSON',
        value: function HTMLtoJSON(html, title) {
        ...
        */
        ...
        value: function getFilenameFromURL(path) {
